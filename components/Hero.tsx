  ...
  return (
    <section className="relative ">
      <section className=" w-full bg-[url('/images/heroBg.svg')] bg-cover bg-no-repeat z-10 border-b  border-[#22c55e]">
        ...
        {/* Hero content */}
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-6 pt-30 pb-10">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-[#238636]/10 border border-[#238636]/30 text-green-400 px-4 py-1.5 rounded-full text-xs font-semibold tracking-widest uppercase mb-8">
            <Image src="/images/star.svg" alt="star" height={20} width={20} />
            AI-Powered Assistant
          </div>

          {/* Headline */}
          <h1 className="text-5xl md:text-7xl lg:text-6xl font-extrabold leading-tight tracking-tight max-w-6xl">
          ...
          {/* Subheadline */}
          <p className="mt-6 text-[#CAFFD6] text-lg max-w-xl leading-relaxed">
          ...
          <div className="flex items-center gap-4 mt-10">
            {user ? (
              <Link
                href="/dashboard"
                className="bg-[#238636] hover:bg-[#2ea043] text-[#CAFFD6] font-semibold px-6 py-3 rounded-lg transition-colors flex items-center gap-2 text-base"
              >
                <svg
                  className="w-6 h-6"
                  fill="none"
        ...
        <div className="relative flex flex-col items-center justify-end opacity-85">
          <Image
            ...
            sizes="100vw"
            className="h-auto" // Tailwind forces the height and auto-scales width
          />
        </div>
      </section>
    </section>
