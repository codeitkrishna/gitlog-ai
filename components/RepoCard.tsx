    ...
    >
      ...
      <div className="flex items-start justify-between gap-3 mb-3">
        <div className="flex items-center gap-3 min-w-0">
          <svg
            className="w-5 h-5 text-[#CAFFD6] shrink-0"
            fill="currentColor"
            viewBox="0 0 24 24"
          >
            <path d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" />
          </svg>
          <h3 className="text-[#22c55e] font-semibold group-hover:underline truncate min-w-0">
            {repo.name}
          </h3>
        </div>
        {repo.isPrivate && (
      ...
      {/* Metadata */}
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-[#CAFFD6]">
        {repo.language && (
        ...
        <div className="text-[#caffd6] sm:ml-auto">
          {repo.updatedAt && (
            <div>
              Updated{" "}
